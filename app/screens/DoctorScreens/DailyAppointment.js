...
function DailyAppointment(props) {
    ...
    useEffect(()=>{ 
        setLoading(true);
        fetch(`${secretkeys.localhost}/getdailyapt`, {
            method:"POST",
            headers:{
        ...
        if (data.error){
            ...
            setLoading(false)
            setApt(data.appointments.sort((a,b)=>{
    ...
    return (
        ...
        <Text style={styles.Headings} >Daily Appointments</Text>
            <View >
            <FlatList data={apt}
